...
if($_SERVER["REQUEST_METHOD"] === "POST"){
    ...
    if(empty(trim($_POST["email"]))){
        $email_err = "Por favor, ingrese el correo eletrónico";
    }else{
            ...
            if(mysqli_stmt_num_rows($stmt) ==1){
                ...
                if(mysqli_stmt_fetch($stmt)){
                    if(password_verify($password, $hashed_password)){
                        ...
                        $password_err = "La contrasela que has introducido no es valida";
                    }
                }
            }else{
                ...
                echo "UPS! algo salio mal, inténtalo mas tarde";
             }
}
